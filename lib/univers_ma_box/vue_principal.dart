...
class PrinciaplScreenOfUnivers extends StatefulWidget {
  ...
  @override
  State<PrinciaplScreenOfUnivers> createState() => _PrinciaplScreenOfUniversState();
}
      ...
      child: ToggleButtons(
        ...
        children: [
          ...
          Container(
           ...
           border: _isSelect[0]?  const Border(bottom: BorderSide(color: Color(0xFFFF7900))) :const Border(bottom: BorderSide(color: Color.fromARGB(255, 239, 238, 238)))
            ),
            child: Text("Ma box",style: TextStyle(color:  _isSelect[0]? Color(0xFFFF7900):  Color.fromARGB(255, 0, 0, 0) ,fontSize: 14.sp,fontWeight: FontWeight.w500)),
          ),
           ...
           Container(
            ...
            decoration: BoxDecoration(
              border: _isSelect[1]?  const Border(bottom: BorderSide(color: Color(0xFFFF7900))) :const Border(bottom: BorderSide(color: Color.fromARGB(255, 239, 238, 238)))
            ),
            child: Text("Mes services",style: TextStyle(color:  _isSelect[1]?  Color(0xFFFF7900): Color.fromARGB(255, 0, 0, 0),fontSize: 14.sp,fontWeight: FontWeight.w500)),
          ),
        ],

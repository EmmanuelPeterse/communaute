...
class LevelArgent extends StatelessWidget {
  ...
  return Container(
       decoration: BoxDecoration(
        border: Border.all(color: Color(0xFFB8BABA)),
        borderRadius: BorderRadius.circular(5),
        image: DecorationImage(image: AssetImage('assets/images/Background3.png',),fit: BoxFit.cover)
         ...
         Row(
          ...
          children: [
            ...
            child:  Row(
              ...
              children: [
                 SvgPicture.asset("assets/images/svglocked.svg",color: const Color(0xFF656161),),        
                         SizedBox(width: 2,),
                Text("Niveau supérieur à atteindre",style: TextStyle(color: Color(0xFF837878),fontWeight: FontWeight.w700,fontSize: 11),)
              ],
            ),
          ),
          ],

...
class LevelArgent extends StatelessWidget {
  const LevelArgent({super.key});

  @override
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
          border: Border.all(color: const Color(0xFFB8BABA)),
        ...
        children: [
          Row(
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                    color: const Color(0xFFB8BABA),
                    borderRadius: BorderRadius.circular(5)),
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    SvgPicture.asset(
                      "assets/images/svglocked.svg",
          ...
          Row(
            children: [
              ...
              _cardre_Suprise(
                  "assets/images/svgcadeaux.svg", "Cadeaux\nsuprise"),
              _cardre_SupriseSvg(
                  "assets/images/transfer.png", " Transfert\nligne offert "),
              _cardre_Suprise(
                  "assets/images/svgvip.svg", "Evènement\n       VIP"),
              _cardre_Suprise(
                  "assets/images/svginterne.svg", "Backup\nInternet"),
            ],
          ),
          Row(
            children: [
  ...
  _cardre_SupriseSvg(supriceIcons, text) {
    return Container(
      ...
      decoration:
          const BoxDecoration(color: Color(0xFFFBFBFB), shape: BoxShape.circle),
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          Image.asset(
